...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 18 Octobre 2016 à 13:50
...
('a17', '201610', 0, '0.00', '2016-10-04', 'CR');
...
INSERT INTO `profil` (`codeProfil`, `profil`) VALUES
(1, 'Visiteur'),
(2, 'Comptable');
...
INSERT INTO `utilisateur` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`, `codeProfil`) VALUES
